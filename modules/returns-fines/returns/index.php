...
.search-wrap input{padding:9px 16px;border:2px solid #C7D8F8;border-radius:9px;font-family:'Nunito',sans-serif;font-size:.875rem;color:var(--navy);outline:none;width:260px;background:#fff}
.search-wrap input:focus{border-color:var(--blue-dark)}
.search-wrap button{padding:9px 18px;background:var(--blue-dark);color:#fff;border:none;border-radius:9px;cursor:pointer;font-size:.875rem;font-weight:700;font-family:'Nunito',sans-serif}
.btn-proses{display:inline-flex;align-items:center;gap:7px;padding:10px 22px;background:linear-gradient(135deg,var(--navy),var(--blue-dark));color:#fff;text-decoration:none;border-radius:10px;font-size:.875rem;font-weight:700;font-family:'Nunito',sans-serif;transition:opacity .2s;white-space:nowrap}
.btn-proses:hover{opacity:.9}
/* Tabs */
.tabs{display:flex;gap:4px;background:#E2ECF8;border-radius:12px;padding:4px;margin-bottom:20px;width:fit-content}
.tab{padding:8px 20px;border-radius:8px;font-size:.875rem;font-weight:600;cursor:pointer;border:none;background:transparent;color:var(--muted);font-family:'Nunito',sans-serif;transition:all .2s}
.tab.active{background:#fff;color:var(--blue-dark);box-shadow:0 2px 8px rgba(37,99,235,.12)}
/* Table card */
...
.badge-tepat{background:#DCFCE7;color:#166534}
...
.modal{background:#fff;border-radius:20px;padding:32px;width:100%;max-width:560px;box-shadow:0 20px 60px rgba(0,0,0,.2)}
.modal h2{font-size:1.2rem;font-weight:800;color:var(--navy);margin-bottom:4px}
.modal .subtitle{font-size:.85rem;color:var(--muted);margin-bottom:24px}
.form-group{margin-bottom:18px}
.form-group label{display:block;font-size:.82rem;font-weight:700;color:var(--navy);margin-bottom:6px}
.form-group select,.form-group input,.form-group textarea{width:100%;padding:10px 14px;border:2px solid #C7D8F8;border-radius:9px;font-family:'Nunito',sans-serif;font-size:.875rem;color:var(--navy);outline:none;background:#fff}
.form-group select:focus,.form-group input:focus,.form-group textarea:focus{border-color:var(--blue-dark)}
.denda-preview{background:#FEF3C7;border:1px solid #FDE68A;border-radius:10px;padding:14px 18px;margin-bottom:18px;display:none}
.denda-preview.show{display:block}
.denda-preview .denda-label{font-size:.78rem;font-weight:700;color:#92400E;text-transform:uppercase;letter-spacing:.5px}
.denda-preview .denda-val{font-size:1.3rem;font-weight:800;color:#92400E;margin-top:2px}
.form-actions{display:flex;gap:10px;justify-content:flex-end;margin-top:24px}
.btn-cancel{padding:10px 22px;background:#F1F5F9;color:var(--muted);border:none;border-radius:10px;font-family:'Nunito',sans-serif;font-size:.875rem;font-weight:700;cursor:pointer}
.btn-submit{padding:10px 24px;background:linear-gradient(135deg,var(--navy),var(--blue-dark));color:#fff;border:none;border-radius:10px;font-family:'Nunito',sans-serif;font-size:.875rem;font-weight:700;cursor:pointer;transition:opacity .2s}
.btn-submit:hover{opacity:.9}
.radio-group{display:flex;gap:12px;flex-wrap:wrap}
.radio-group label{display:flex;align-items:center;gap:6px;font-size:.85rem;font-weight:600;color:#374151;cursor:pointer}
@media(max-width:640px){.sidebar{display:none}.main{margin-left:0}.content{padding:16px}}
</style>
</head>
<body>
