            ...
            <form method="POST">
                <div class="grid2">
                    <div class="fg">
                        ...
                        <input type="text" name="kode" required value="<?= htmlspecialchars($_POST['kode'] ?? $category['kode']) ?>">
                    </div>
                    <div class="fg">
                        <label>Nama Kategori</label>
                        <input type="text" name="nama" required value="<?= htmlspecialchars($_POST['nama'] ?? $category['nama']) ?>">
                    </div>
                    <div class="fg full">
                        <label>Deskripsi</label>
                        <textarea name="deskripsi"><?= htmlspecialchars($_POST['deskripsi'] ?? $category['deskripsi']) ?></textarea>
                    </div>
                </div>
